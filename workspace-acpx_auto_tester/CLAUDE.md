...
The `statemachine` branch landed a v2 enrichment of the per-issue label model. Full semantics live in [`statemachine.v2.md`](statemachine.v2.md) (pure state-machine memory) and the SKILL's [`references/label_lifecycle.md`](skills/gitlab_issue_campaign_dispatcher/references/label_lifecycle.md). The four facts below are what the dispatcher implements today.
