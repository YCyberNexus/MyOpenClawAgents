...
```json
{
  ...
  "model_tiers": [
    {"tier": "flash", "settings": "hulat/.claude/settings.flash.json"},
    {"tier": "pro",   "settings": "hulat/.claude/settings.pro.json"},
    {"tier": "max",   "settings": "hulat/.claude/settings.max.json"}
  ],
