...
| `prior_attempt_count`     | continue mode only — number of past `acpx_auto_tester_test:attempt-summary` notes (plus legacy pre-rename attempt-summary notes) the prompt included |
