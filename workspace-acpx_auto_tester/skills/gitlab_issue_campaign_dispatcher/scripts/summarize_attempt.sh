...
# reviewer comments:
#
#   <!-- acpx_auto_tester_ifp:attempt-summary v2 attempt=NNN -->
#   ...short summary...
#   <!-- /acpx_auto_tester_ifp:attempt-summary -->
...
{
  echo "<!-- acpx_auto_tester_ifp:attempt-summary v2 attempt=${ATTEMPT_NUMBER_PADDED} -->"
  echo "## acpx_auto_tester_ifp attempt ${ATTEMPT_NUMBER_PADDED}"
  echo
  ...
  echo
  echo "<!-- /acpx_auto_tester_ifp:attempt-summary -->"
} > "${SUMMARY_FILE}"
