...
#   - Past attempt summaries  (notes posted by acpx_auto_tester_ifp itself, marked
#                              with <!-- acpx_auto_tester_ifp:attempt-summary ... -->;
...
CURRENT_AGENT_MARKER_PREFIX="acpx_auto_tester_ifp"
