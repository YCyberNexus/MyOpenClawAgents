...
#   - Past attempt summaries  (notes posted by acpx_auto_tester_pts itself, marked
#                              with <!-- acpx_auto_tester_pts:attempt-summary ... -->;
...
CURRENT_AGENT_MARKER_PREFIX="acpx_auto_tester_pts"
