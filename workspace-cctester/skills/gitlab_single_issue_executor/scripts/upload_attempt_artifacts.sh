...
{
  echo "<!-- cctester:attempt-wiki-artifacts v1 attempt=${ATTEMPT_NUMBER_PADDED} -->"
  echo "## cctester attempt ${ATTEMPT_NUMBER_PADDED} OpenClaw logs"
  echo
  ...
  echo
  echo "<!-- /cctester:attempt-wiki-artifacts -->"
} > "${NOTE_FILE}"
