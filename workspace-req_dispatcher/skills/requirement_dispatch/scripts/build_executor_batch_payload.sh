...
validate_scalar_value AUTO_MERGE "${AUTO_MERGE}"
...
validate_scalar_value MERGE_TARGET_BRANCH "${MERGE_TARGET_BRANCH}"
...
case "${AUTO_MERGE}" in
  true|false) ;;
  *)
    echo "AUTO_MERGE must be true or false" >&2
    exit 2
    ;;
esac
