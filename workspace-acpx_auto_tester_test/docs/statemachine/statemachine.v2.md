...
> 实现仓库：`workspace-acpx_auto_tester_test/`（脚本 `scripts/`）。
>
> **权威以脚本与 reference 为准。** 本文件与 [`workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/label_lifecycle.md`](workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/label_lifecycle.md) / [`references/state_schema.md`](workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/state_schema.md) 冲突时，以那两个为准。
>
> **本分支关键特征（先读这段）：**
