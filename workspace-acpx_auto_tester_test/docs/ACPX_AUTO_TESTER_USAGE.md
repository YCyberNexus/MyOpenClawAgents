...
详细实现契约位于
`workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/`。本文只描述人需要
知道和配置的内容。
...
- `workspace-acpx_auto_tester_test/USER.md`
- `workspace-acpx_auto_tester_test/SOUL.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/SKILL.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/trigger_command.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/dispatcher_wrappers.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/executor_prompt.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/state_schema.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/label_lifecycle.md`
- `workspace-acpx_auto_tester_test/skills/gitlab_issue_campaign_dispatcher/references/paths.md`
