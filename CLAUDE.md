...
Every non-trivial code change MUST go through the review loop before the task is considered complete. The reviewer is **Codex** (`codex review` via Bash), whose stdout is visible to the user — not a black-box subagent.
