...
# reviewer comments:
#
#   <!-- req_executor:attempt-summary v2 attempt=NNN -->
#   ...short summary...
#   <!-- /req_executor:attempt-summary -->
...
{
  echo "<!-- req_executor:attempt-summary v2 attempt=${ATTEMPT_NUMBER_PADDED} -->"
  ...
  echo
  echo "<!-- /req_executor:attempt-summary -->"
} > "${SUMMARY_FILE}"
